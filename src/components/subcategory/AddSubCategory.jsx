...
import {  usePostSubCategoryController } from "@/controller/subcategoryController";
...
const AddSubCategory = () => {
  const { open, setOpen } = useSubCategoryContext();
  const { mutate, isPending } = usePostSubCategoryController();
