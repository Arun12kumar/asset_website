...
import { usePostCategoryController } from "@/controller/categoryController";
...
const AddCategory = () => {
  const { open, setOpen } = useCategoryContext();
  const { mutate, isPending } = usePostCategoryController();
  ...
  return (
    ...
    >
      ...
      >
        <DialogHeader>
          <DialogTitle className="text-start">Add Category</DialogTitle>
